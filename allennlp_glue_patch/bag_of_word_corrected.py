...
@TokenEmbedder.register("bag_of_word_counts_corrected")
class CorrectedBagOfWordCountsTokenEmbedder(TokenEmbedder):
    """
    ...
    def forward(self,  # pylint: disable=arguments-differ
        ...
        ori_shape = bag_of_words_output.shape
        return bag_of_words_output.reshape((ori_shape[0], 1, ori_shape[1]))
