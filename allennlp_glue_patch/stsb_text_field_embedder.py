...
@TextFieldEmbedder.register("stsb")
class BasicTextFieldEmbedder(TextFieldEmbedder):
    ...
    def __init__(self,
                 ...
                 output_key_specified: bool = False) -> None:
        ...
        self._output_key_specified = output_key_specified
    ...
    def forward(self, text_field_input: Dict[str, torch.Tensor],
        ...
        for key in keys:
            ...
            if self._embedder_to_indexer_map is not None:
                ...
                token_vectors = embedder(*tensors, **forward_params_values)
            if self._output_key_specified:
                embedded_representations[key] = token_vectors
            else:
                embedded_representations.append(token_vectors)
        if self._output_key_specified:
            return embedded_representations
        else:
    ...
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'BasicTextFieldEmbedder':  # type: ignore
        ...
        output_key_specified = params.pop_bool("output_key_specified", False)
        ...
        return cls(token_embedders, embedder_to_indexer_map, allow_unmatched_keys, output_key_specified)
